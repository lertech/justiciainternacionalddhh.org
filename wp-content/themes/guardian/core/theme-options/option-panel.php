	...
	<div class="wrap" id="weblizar_wrap" >		
		<div class="wbl-notify" id="wbl-notify">
			<div class="col-md-12">
				...
				<div class="col-md-3" style="padding-top:20px; text-align:right;">
					<a style="margin-bottom:20px" href="<?php echo $purchase; ?>" target="blank" class="btn btn-success btn-lg"><?php _e('View Guardian Pro Demo','weblizar'); ?> </a>
					<a href="<?php echo $purchase; ?>" target="_blank" class="btn btn-danger btn-lg" ><?php _e('Upgrade to Guardian Pro','weblizar'); ?></a>
				</div>
				<div class="col-md-3">
		...
		<div id="content_wrap">			
			<div class="weblizar-header" >
				<h2><span><?php _e('Guardian Theme Settings','weblizar'); ?></span></h2>			
