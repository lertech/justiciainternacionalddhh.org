...
?>
        <?php
	  	$freemium_archives = get_the_category();
		$freemium_archives_name = $freemium_archives[0]->name;
		$freemium_archives_id = $freemium_archives[0]->cat_ID;
	  ?>  
	...
	<div class="container no-padding">
        ...
        <div class="col-md-12 no-padding-right margin-bottom-3">
        	 <div class="col-md-12 white-bg search-freemium">
        		<h1><?php _e('Category','freemium'); echo " :".single_cat_title( '', false ); ?></h1>
			</div>
        </div> 
